...
let despesa = new Despesa(ano.value,
    ...
    if (despesa.validarDados(despesa)){
          ...
          document.getElementById('modal_titulo').innerHTML='Erro ao gravar despesa'
 ...
 */
 ...
 /*  percorrer o array despesas*/
  ...
  despesas.forEach(function(d){
   ...
   //criar elemento para excluir despesa
   ...
   btn.onclick = function () {
    ...
    let id = this.id.replace('id_despesa_','')
     ...
     document.getElementById('modal_titulo_div').className = 'modal-header text-success'
     document.getElementById('modal_conteudo').innerHTML='Registro excluido com sucesso'
     document.getElementById('modal_btn').innerHTML='Voltar'
     document.getElementById('modal_btn').className = 'btn btn-success'
...
function pesquisarDespesas() {
  ...
  let despesas = Array()
   //metodo pesquisar no banco local
